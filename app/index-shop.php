	...
	<?php echo $hidden_inpunt; ?>
		...
		<section class="any-work" id="any-work">
			<div class="container">
				...
				<h3  id="steps-h">у нас есть все необходимые инструменты для оформления <span class="text-orange">оффлайн-бизнеса</span></h3>
...
Отлично подойдет для локальной вывески (вывеска, витрины магазина), так и для геотаргетинговой (рекламные банеры, вывески).</p>
							</div>
							<div class="tab-cont" id="text-3">
								<p>Высокое качество печати, с хорошей передачей цвета и контрастности изображений, делают продукцию максимально реалистичной </p><p>
...
Наилучшее решение для крупного бизнеса.</p>
							...
							<div class="tab-cont" id="text-5">
								<p>Материалы, способствующие продвижению бренда или товара в местах продаж (ценникодержатели, воблеры, ценники..)</p><p>
